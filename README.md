...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&height=190&color=0:0f172a,48:1d4ed8,100:22c55e&text=Nika%20Topuria&fontSize=54&fontColor=ffffff&fontAlignY=36&desc=Software%20Engineer%20from%20Georgia&descAlignY=57&descSize=18&animation=fadeIn" alt="Nika Topuria" />
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>⚡ Voli</h3>
      <p>A fast Windows package manager with no admin rights, registry changes, or install scripts.</p>
      <a href="https://github.com/Topurrra/voli">Explore Voli →</a>
    </td>
    <td width="50%" valign="top">
      <h3>📖 The Missing Manual</h3>
      <p>A free, text-first library for developers and STEM learners who want clarity without the noise.</p>
      <a href="https://github.com/Topurrra/themissingmanual">Read the project →</a>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
